...
public class PositionAnimator {
    ...
    synchronized public void animate(final Marker marker, final GroundOverlay groundOverlay, final Location location) {
        ...
        final float groundOverlayDiameter = location.getAccuracy() / 8.0f ;
